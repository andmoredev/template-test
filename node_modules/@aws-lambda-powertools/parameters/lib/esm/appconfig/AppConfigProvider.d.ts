...
import type { AppConfigProviderOptions, AppConfigGetOptions, AppConfigGetOutput } from '../types/AppConfigProvider.js';
/**
 * ## Intro
...
declare class AppConfigProvider extends BaseProvider {
    ...
    protected configurationTokenStore: Map<string, {
        value: string;
        expiration: number;
    }>;
