...
const AppConfigProvider_js_1 = require("./AppConfigProvider.js");
 ...
 */
const getAppConfig = (name, options) => {
    if (!index_js_1.DEFAULT_PROVIDERS.hasOwnProperty('appconfig')) {
        index_js_1.DEFAULT_PROVIDERS.appconfig = new AppConfigProvider_js_1.AppConfigProvider({
            application: options?.application,
            environment: options.environment,
        });
    }
    return index_js_1.DEFAULT_PROVIDERS.appconfig.get(name, {
