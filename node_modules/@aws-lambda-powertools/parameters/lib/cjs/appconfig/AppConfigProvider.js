...
exports.AppConfigProvider = void 0;
 ...
 */
class AppConfigProvider extends BaseProvider_js_1.BaseProvider {
    /**
    ...
    constructor(options) {
        super({
            proto: client_appconfigdata_1.AppConfigDataClient,
    ...
    async _get(name, options) {
        if (!this.configurationTokenStore.has(name) ||
            ...
            this.configurationTokenStore.set(name, {
                ...
                expiration: Date.now() + constants_js_1.APPCONFIG_TOKEN_EXPIRATION,
            });
        }
