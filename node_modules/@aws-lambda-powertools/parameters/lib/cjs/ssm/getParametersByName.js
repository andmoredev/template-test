...
const getParametersByName = async (parameters, options) => {
    if (!DefaultProviders_js_1.DEFAULT_PROVIDERS.hasOwnProperty('ssm')) {
        DefaultProviders_js_1.DEFAULT_PROVIDERS.ssm = new SSMProvider_js_1.SSMProvider();
    }
    return DefaultProviders_js_1.DEFAULT_PROVIDERS.ssm.getParametersByName(parameters, options);
};
