...
const SecretsProvider_js_1 = require("./SecretsProvider.js");
/**
 * ## Intro
...
const getSecret = async (name, options) => {
    if (!DefaultProviders_js_1.DEFAULT_PROVIDERS.hasOwnProperty('secrets')) {
        DefaultProviders_js_1.DEFAULT_PROVIDERS.secrets = new SecretsProvider_js_1.SecretsProvider();
    }
    return DefaultProviders_js_1.DEFAULT_PROVIDERS.secrets.get(name, options);
};
